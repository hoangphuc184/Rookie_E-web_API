...
public class SuccessCode {
    ...
    public static final String LIST_CATE_LOADED_SUCCESS = "LIST_CATE_LOADED_SUCCESS";
    ...
    /** DISCOUNT **/
    public static final String DISCOUNT_LOADED_SUCCESS = "DISCOUNT_LOADED_SUCCESS";

    public static final String LIST_DISC_LOADED_SUCCESS = "LIST_DISC_LOADED_SUCCESS";

    public static final String DISCOUNT_CREATED_SUCCESS = "DISCOUNT_CREATED_SUCCESS";

    public static final String DISCOUNT_DELETED_SUCCESS = "DISCOUNT_DELETED_SUCCESS";

    public static final String DISCOUNT_UPDATED_SUCCESS = "DISCOUNT_UPDATED_SUCCESS";

    /** PRODUCT **/
    public static final String PRODUCT_LOADED_SUCCESS = "PRODUCT_LOADED_SUCCESS";

    public static final String LIST_PRO_LOADED_SUCCESS = "LIST_PRO_LOADED_SUCCESS";
